...
save_game = "MENELIK - Roraima.Civ6Save"
# save_game = "MENELIK - Torres del Paine.Civ6Save"
# save_game = "LADY SIX SKY - Roraima.Civ6Save"

with open(save_game, 'rb') as civ6_sav:
    data = civ6_sav.read()
